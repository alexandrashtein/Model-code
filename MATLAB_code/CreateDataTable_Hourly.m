...
clear
clc
cd 'N:\Projects\P028.IL.Israel.MAIAC.PM.V2\work\Meteorological_Data\Hourly_data\Terra_Hourly_data_July16';
%Create cell variable ('DATA') with a column for each variable (defined in
%'colnames')
for I=5:8
    Infilename={'PM25','PM10','RH','Temp','WD','SR','WS','Rain','NO2','NO','O3','SO2'};
    file= ['HourlyAVG_' Infilename{I} '.mat'];
    load (file)
    ...
    writetable(s,[Infilename{I} '_H.csv']);
end