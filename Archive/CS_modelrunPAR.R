...
# AQUA data
mod1 <-readRDS("N:/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1/2014/mod1.AQ.2014.PM25_Daily.rds")
# mod1<-readRDS("N:/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1/2014/mod1.AQ.2014.PM25_Hourly.rds")

# TERRA data
# mod1 <-readRDS("N:/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1/2014/mod1.TR.2014.PM25_Daily.rds")
# mod1 <-readRDS("N:/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1/2014/mod1.TR.2014.PM25_Hourly.rds")
...
mod1$Ur_Ru[20<= mod1$Ur_Ru & mod1$Ur_Ru<=40] <-2
mod1$Ur_Ru[40<= mod1$Ur_Ru & mod1$Ur_Ru<=60] <-3
mod1$Ur_Ru[60<= mod1$Ur_Ru & mod1$Ur_Ru<=80] <-4
mod1$Ur_Ru[mod1$Ur_Ru>=80] <-5
...
# delete unnecessery columns for 2007-2014
...
# mod1[,c("sp_ndvi_L14","su_ndvi_L14","m","lon_200m","lat_200m","ndviid","FS_BS","Su_NDVI14_200m","Sp_NDVI14_200m","P_Ag_2014","P_In_Min_2014","P_OS_2014","P_OS_Ag_2014","P_Ag_2014_200m","P_Ur_2014_200m","P_In_Min_2014_200m","P_OS_Ag_2014_200m","P_OS_2014_200m"):=NULL]
...
# names for AQUA daily mod1- for year > 2007

names=c("Elev","sp_ndvi_L14","su_ndvi_L14","dis_inventory","Dis_Mroads","road_den","Pop_dens","Dis_Rd1_2012","Dis_Rd2_2012","Dist_Railw",
        "Dist_WB","metreg_IA" ,"metreg" ,"aridity_in","Temp_D","P_Ag_2014","P_In_Min_2014","P_OS_2014","P_OS_Ag_2014","P_Ur_2014",
...
# names for hourly mod1 AQUA- for years > 2007
...
# "Road_den_200m" ,"Road_dis_200m","Dis_Railways_200m" ,"Sp_NDVI14_200m","Su_NDVI14_200m","P_Ag_2014_200m","P_In_Min_2014_200m","P_OS_Ag_2014_200m","P_OS_2014_200m","P_Ur_2014_200m","dist_inven_200m","ndvi")


# names for Daily mod1 AQUA- for years < 2007
...
# names for TERRA daily mod1- for year > 2007

# names=c("Elev","sp_ndvi_L14","su_ndvi_L14","dis_inventory","Dis_Mroads","road_den","Pop_dens","Dis_Rd1_2012","Dis_Rd2_2012","Dist_Railw",
# "Dist_WB","metreg_IA" ,"metreg" ,"aridity_in","Temp_D", "P_Ag_2014","P_In_Min_2014","P_OS_2014","P_OS_Ag_2014","P_Ur_2014",
# "WS_D","RH_D","Rain_D","NO2_D" ,"SO2_D","pbl_02","pbl_08","vc_D","aod_055_mean","aod_047_mean","Elev_200m","Pop_dens_200m",
# "Road_den_200m" ,"Road_dis_200m","Dis_Railways_200m" ,"P_Ag_2014_200m","P_In_Min_2014_200m","P_OS_Ag_2014_200m","P_OS_2014_200m","P_Ur_2014_200m","Sp_NDVI0002_200m",
# "Sp_NDVI14_200m","Su_NDVI0002_200m","Su_NDVI14_200m","dist_inven_200m","ndvi","daily_hpbl")

# names for hourly mod1 TERRA- for years > 2007
...
# "P_Ag_2014_200m","P_In_Min_2014_200m","P_OS_2014_200m","P_Ur_2014_200m","dist_inven_200m")

# names for Daily mod1 TERRA- for years > 2007
...
# "P_Ag_2014_200m","P_In_Min_2014_200m","P_OS_2014_200m","P_Ur_2014_200m","dist_inven_200m","daily_hpbl")
...
m1.formula <- as.formula(PM25 ~ aod_047_mean
# #spatial
+Elev.scaled+sp_ndvi_L14.scaled + su_ndvi_L14.scaled + dis_inventory.scaled + Dis_Mroads.scaled 
+ road_den.scaled + Pop_dens.scaled + Dis_Rd1_2012.scaled + Dis_Rd2_2012.scaled + Dist_Railw.scaled
...
m1.formula <- as.formula(PM25 ~ aod_047_mean
                         # #spatial
                         +Elev.scaled+ndvi.scaled + dis_inventory.scaled + Dis_Mroads.scaled 
                         + Pop_dens.scaled
                         ...
                         #met
                         + Temp_D.scaled+Rain_D.scaled+RH_D.scaled+WS_D.scaled+SO2_D.scaled+NO2_D.scaled
                         +(1+aod_047_mean|day/Ur_Ru))

# # #v1 mixed model
# m1.formula <- as.formula(PM25 ~ aod_047_mean
#                          # #spatial
#                          +Elev.scaled+
#                          + road_den.scaled + Pop_dens.scaled + Dis_Rd1_2012.scaled + Dist_Railw.scaled+
#                            P_Ag_2004.scaled+P_In_2004.scaled+P_Ag_2004.scaled+P_OS_2004.scaled
#                          #temporal
#                          + ndvi.scaled+ pbl_02.scaled+pbl_11.scaled+vc_D.scaled
#                          #met
#                          + Temp_D.scaled+Rain_D.scaled+RH_D.scaled+WS_D.scaled+SO2_D.scaled+NO2_D.scaled
#                          +(1+aod_047_mean|day/metreg))
...
# x<-gam(PM25~ s(pbl_11),data=mod1)
# plot(x)
# summary(x)

#save MOD1 
# saveRDS(mod1,"N:/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_pred/mod1_Daily.AQ.2014.PM25.predm1.rds")
saveRDS(mod1,"N:/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_pred/mod1_Daily.AQ.2014.PM25_clean.predm1.rds")
# saveRDS(mod1,"N:/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_pred/mod1_hourly.AQ.2014.PM25_clean.predm1.rds")
# saveRDS(mod1,"N:/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_pred/mod1_hourly.AQ.2014.PM25.predm1.rds")

# saveRDS(mod1,"N:/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_pred/mod1_Daily.TR.2014.PM25.predm1.rds")
# saveRDS(mod1,"N:/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_pred/mod1_Daily.TR.2014.PM25_clean.predm1.rds")
# saveRDS(mod1,"N:/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_pred/mod1_hourly.TR.2014.PM25_clean.predm1.rds")
# saveRDS(mod1,"N:/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_pred/mod1_hourly.TR.2014.PM25.predm1.rds")

# Save AQUA results 
    # saveRDS(res,"N:/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/results.mod1.AQ.2014.PM25_Daily.rds")
    saveRDS(res,"N:/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/results.mod1.AQ.2014.PM25_Daily_clean.rds")
    # saveRDS(res,"N:/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/results.mod1.AQ.2014.PM25_Hourly_clean.rds")
    # saveRDS(res,"N:/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/results.mod1.AQ.2014.PM25_Hourly.rds")  
# Save TERRA results
    # saveRDS(res,"N:/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/results.mod1.TR.2014.PM25_Daily.rds")
    # saveRDS(res,"N:/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/results.mod1.TR.2014.PM25_Daily_clean.rds")
    # saveRDS(res,"N:/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/results.mod1.TR.2014.PM25_Hourly_clean.rds")
    # saveRDS(res,"N:/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/results.mod1.TR.2014.PM25_Hourly.rds")
...
mod1.cv = do.call(rbind, test_final)
      ...
      #save
# AQUA
      # saveRDS(mod1.cv,"N:/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_CV/mod1.AQ.2014.PM25_Daily_CV.rds")     
      saveRDS(mod1.cv,"N:/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_CV/mod1.AQ.2014.PM25_Daily_clean_CV.rds")
      # saveRDS(mod1.cv,"N:/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_CV/mod1.AQ.2014.PM25_Hourly_CV.rds")
      # saveRDS(mod1.cv,"N:/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_CV/mod1.AQ.2014.PM25_Hourly_clean_CV.rds")

# TERRA
      # saveRDS(mod1.cv,"N:/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_CV/mod1.TR.2014.PM25_Hourly_clean_CV.rds")
      # saveRDS(mod1.cv,"N:/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_CV/mod1.TR.2014.PM25_Hourly_CV.rds")
      # saveRDS(mod1.cv,"N:/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_CV/mod1.TR.2014.PM25_Daily_CV.rds")     
      # saveRDS(mod1.cv,"N:/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_CV/mod1.TR.2014.PM25_Daily_clean_CV.rds")
...
#        Sp_NDVI14_200m.scaled+ P_Ur_2004_200m.scaled +  P_Ag_2004_200m.scaled +P_In_Min_2004_200m.scaled + 
#       P_OS_2004_200m.scaled  ,data=mod1.cv)
# 
# reg=lm(res.m1~ Elev_200m.scaled + Road_den_200m.scaled + Road_dis_200m.scaled + Pop_dens_200m.scaled+    
#          Sp_NDVI14_200m.scaled +  P_Ag_2004_200m.scaled +P_In_Min_2004_200m.scaled + 
#           P_Ur_2004_200m.scaled ,data=mod1.cv)
# 
# reg=lm(res.m1~ Elev_200m.scaled + Pop_dens_200m.scaled+Road_dis_200m.scaled +     
#          Dis_Railways_200m.scaled +  Su_NDVI0002_200m.scaled + P_Ur_2004_200m.scaled+dist_inven_200m.scaled
#        +P_In_2004_200m.scaled ,data=mod1.cv)
# 
# summary(reg)
...
A_res_clean_D=readRDS("N:/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2014/results.mod1.AQ.2014.PM25_Daily_clean.rds")
...
A_res_all_D=readRDS("N:/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2014/results.mod1.AQ.2014.PM25_Daily.rds")
A_res_all_D= subset(A_res_all_D, select = -c(m1cvloc.I))
A_res_all_D=A_res_all_D[,c(1:35)]

# (3) read AQUA Hourly clean model results
A_res_clean_H=readRDS("N:/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2014/results.mod1.AQ.2014.PM25_Hourly_clean.rds")
...
A_res_all_H=readRDS("N:/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2014/results.mod1.AQ.2014.PM25_Hourly.rds")
A_res_all_H=A_res_all_H[,c(1:35)]

# (5) read TERRA Daily clean model results
T_res_clean_D=readRDS("N:/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2014/results.mod1.TR.2014.PM25_Daily_clean.rds")
T_res_clean_D=T_res_clean_D[,c(1:35)]

# (6) read TERRA Daily all obs n model results
T_res_D_all=readRDS("N:/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2014/results.mod1.TR.2014.PM25_Daily.rds")
T_res_D_all=T_res_D_all[,c(1:35)]

# (7) read TERRA Hourly clean model results
T_res_clean_H=readRDS("N:/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2014/results.mod1.TR.2014.PM25_Hourly_clean.rds")
T_res_clean_H=T_res_clean_H[,c(1:35)]

# (8) read TERRA Hourly all obs n model results
T_res_all_H=readRDS("N:/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2014/results.mod1.TR.2014.PM25_Hourly.rds")
...
write.csv(res_all,"N:/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2014/results.mod1.2014.PM25.csv")

### mod 2 (around 2-4 h)

mod2 <- readRDS("N:/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod2/AQ.MAIAC.2014.mod2.rds")
...
# # Add MODIS NDVI id data
NDVIid=fread("N:/Projects/P028.IL.Israel.MAIAC.PM.V2/work/Qgis/General/NDVI/MODIS/NDVI_join/1_km_MAIAC_grid_ndviid.csv")
mod2=left_join(mod2,NDVIid,by="aodid")
...
# Second option
mod2$Ur_Ru <- NA
mod2$Ur_Ru<- mod2$P_Ur_2014
mod2$Ur_Ru[mod2$Ur_Ru<=20] <-1 
mod2$Ur_Ru[20<= mod2$Ur_Ru & mod2$Ur_Ru<=80] <-2
mod2$Ur_Ru[mod2$Ur_Ru>=80] <-3
...
mod2 <- select(mod2,day,aodid,PM25_D_mean,long_aod,lat_aod,pred.m2,aod_047_mean)
gc()
...
gc()
names(mod2)
saveRDS(mod2,"N:/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod2_pred/mod2.AQ.2014.PM.predm2.rds")
res[res$type=="PM25", 'm2.R2'] <- print(summary(lm(PM25_D_mean~pred.m2,data=mod2))$r.squared)
...
out<-na.omit(out)
write.csv(out,"D:/Temp/tst_1.csv")
...
#mod 3 (5-8 h)
mod3 <- readRDS("/N:/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod3/AQ.MAIAC.2014.mod3.rds")
