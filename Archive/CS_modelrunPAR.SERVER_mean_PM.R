...
out<-na.omit(out)
write.csv(out,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/Temp/tst_2007_mean_pm.csv")
...
summary(mod3$pred.m3)
   saveRDS(mod3,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod3_pred/mod3.pred.AQ_Daily_clean_bymean_PM.2007.rds")
...
res[res$type=="PM25", 'm3.R2.time'] <-  print(summary(lm(delpm ~ delpred, data=tempoall))$r.squared)
 saveRDS(res, "/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2007/resALL.AQ_Daily_clean.2007.PM25_by mean.rds")
...
# setkey(mod2,aodid)
# maiac_grid=mod2[!duplicated(aodid)]
# coordinates(maiac_grid) = ~ long_aod + lat_aod
# proj4string(maiac_grid) = "+proj=longlat +datum=WGS84 +no_defs +ellps=WGS84 +towgs84=0,0,0"
# writeOGR(maiac_grid,dsn="/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/Temp", layer="mod2_latlon", driver="ESRI Shapefile")
# 

#save
  saveRDS(mod3best,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/Best_pred/bestpred.AQ_Daily_clean.2007.PM25_bymean.rds")
...
#save res
  saveRDS(res, "/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2007/resALL.AQ_Daily_clean.2007.PM25_bymean.rds")
 # saveRDS(res, "/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2007/resALL.AQ_Daily.2007.PM25.rds")
 # saveRDS(res, "/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2007/resALL.AQ_Daily_clean.2007.PM25.rds")
...
# res_clean_mean_PM=readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2007/resALL.AQ_Daily_clean.2007.PM25_bymean.rds")
