...
# AQUA data
mod1 <-readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1/2012/mod1.AQ.2012.PM25_Daily.rds")
# mod1<-readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1/2012/mod1.AQ.2012.PM25_Hourly.rds")

# TERRA data
# mod1 <-readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1/2012/mod1.TR.2012.PM25_Daily.rds")
# mod1 <-readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1/2012/mod1.TR.2012.PM25_Hourly.rds")
...
# hpbl=filter(hpbl,hpbl$year=="2012")
...
# m1.formula <- as.formula(PM25 ~ aod_047_mean
#                          # #spatial
#                          +ns(Elev.scaled,2)+ns(dis_inventory.scaled,8) + ns(Dis_Rd1_2012.scaled,7)
#                          + Pop_dens.scaled
#                          + P_In_Min_2014.scaled+ns(P_Ur_2014.scaled,5)+P_Ag_2014.scaled
#                          #temporal
#                          + ns(daily_hpbl.scaled,7)+vc_D.scaled
#                          #met
#                          + Temp_D.scaled+Rain_D.scaled+RH_D.scaled+ns(WS_D.scaled,9)+NO2_D.scaled
#                          +(1+aod_047_mean|day/Ur_Ru_1))
# 
# ##v1 mixed model
# m1.formula <- as.formula(PM25 ~ aod_047_mean
...
# m1.formula <- as.formula(PM25 ~ aod_047_mean
#                          # #spatial
#                          +ns(Elev.scaled,6)+ns(dis_inventory.scaled,2) + ns(Dis_Rd1_2012.scaled,5)
#                          + Pop_dens.scaled
#                          +P_Ur_2014.scaled
#                          #temporal
#                          + ns(daily_hpbl.scaled,8)+vc_D.scaled
#                          #met
#                          + Temp_D.scaled+Rain_D.scaled+RH_D.scaled+ns(WS_D.scaled,7)+NO2_D.scaled
#                          +(1+aod_047_mean|day/Ur_Ru_1))
...
# summary(x)
# 
# x<-gam(PM25~ s(Dis_Rd1_2012.scaled),data=mod1)
# plot(x)
# summary(x)
# 
...
# summary(x)
# 
# x<-gam(PM25~ s(Elev.scaled)+s(Dis_Rd1_2012.scaled)+s(dis_inventory.scaled)+s(P_In_Min_2014.scaled)+s(P_Ur_2014.scaled)+s(P_Ag_2014.scaled)+s(daily_hpbl.scaled)+s(WS_D.scaled),data=mod1)
# plot(x)
# summary(x)
...
mod1.cv = do.call(rbind, test_final)
      ...
      #save
# AQUA
       saveRDS(mod1.cv,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_CV/mod1.AQ.2012.PM25_Daily_CV.rds")     
      # saveRDS(mod1.cv,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_CV/mod1.AQ.2012.PM25_Daily_clean_CV.rds")
      # saveRDS(mod1.cv,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_CV/mod1.AQ.2012.PM25_Hourly_CV.rds")
      # saveRDS(mod1.cv,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_CV/mod1.AQ.2012.PM25_Hourly_clean_CV.rds")

# TERRA
      # saveRDS(mod1.cv,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_CV/mod1.TR.2012.PM25_Hourly_clean_CV.rds")
      # saveRDS(mod1.cv,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_CV/mod1.TR.2012.PM25_Hourly_CV.rds")
      # saveRDS(mod1.cv,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_CV/mod1.TR.2012.PM25_Daily_CV.rds")     
      # saveRDS(mod1.cv,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_CV/mod1.TR.2012.PM25_Daily_clean_CV.rds")
...
# A_res_clean_D=readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2012/results.mod1.AQ.2012.PM25_Daily_clean.rds")
...
# A_res_all_D=readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2012/results.mod1.AQ.2012.PM25_Daily.rds")
# A_res_all_D= subset(A_res_all_D, select = -c(m1cvloc.I))
# A_res_all_D=A_res_all_D[,c(1:35)]
# 
# # (3) read AQUA Hourly clean model results
# A_res_clean_H=readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2012/results.mod1.AQ.2012.PM25_Hourly_clean.rds")
...
# A_res_all_H=readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2012/results.mod1.AQ.2012.PM25_Hourly.rds")
# A_res_all_H=A_res_all_H[,c(1:35)]
# 
# # (5) read TERRA Daily clean model results
# T_res_clean_D=readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2012/results.mod1.TR.2012.PM25_Daily_clean.rds")
# T_res_clean_D=T_res_clean_D[,c(1:35)]
# 
# # (6) read TERRA Daily all obs n model results
# T_res_D_all=readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2012/results.mod1.TR.2012.PM25_Daily.rds")
# T_res_D_all=T_res_D_all[,c(1:35)]
# 
# # (7) read TERRA Hourly clean model results
# T_res_clean_H=readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2012/results.mod1.TR.2012.PM25_Hourly_clean.rds")
# T_res_clean_H=T_res_clean_H[,c(1:35)]
# 
# # (8) read TERRA Hourly all obs n model results
# T_res_all_H=readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2012/results.mod1.TR.2012.PM25_Hourly.rds")
...
# write.csv(res_all,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2012/results.mod1.2012.PM25.csv")

### mod 2 (around 2-4 h)

mod2 <- readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod2/AQ.MAIAC.2012.mod2.rds")
...
# hpbl=fread("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/HPBL_Israel/newmodel.2004_2015_dailyavg.csv")
# hpbl$year=substr(hpbl$date,1,4)
# hpbl=dplyr::filter(hpbl,hpbl$year=="2012")
# hpbl=as.data.table(hpbl)
# setnames(hpbl,"PBLid","pblid")
# setnames(hpbl,"date","day")
# hpbl$day=as.Date(hpbl$day)
...
gc()
names(mod2)
 saveRDS(mod2,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod2_pred/mod2.AQ_Daily.2012.PM.predm2.rds")
 # saveRDS(mod2,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod2_pred/mod2.AQ_Daily_clean.2012.PM.predm2.rds")
# res[res$type=="PM25", 'm2.R2'] <- print(summary(lm(PM25_IDW~pred.m2,data=mod2))$r.squared)
#keep(mod2,res,rmse,splitdf, sure=TRUE) 


# Save AQUA results 
 saveRDS(res,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/results.mod1.AQ.2012.PM25_Daily.rds")
# saveRDS(res,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/results.mod1.AQ.2012.PM25_Daily_clean.rds")
# saveRDS(res,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/results.mod1.AQ.2012.PM25_Hourly_clean.rds")
# saveRDS(res,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/results.mod1.AQ.2012.PM25_Hourly.rds")  

# Save TERRA results
# saveRDS(res,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/results.mod1.TR.2012.PM25_Daily.rds")
# saveRDS(res,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/results.mod1.TR.2012.PM25_Daily_clean.rds")
# saveRDS(res,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/results.mod1.TR.2012.PM25_Hourly_clean.rds")
# saveRDS(res,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/results.mod1.TR.2012.PM25_Hourly.rds")
...
out<-na.omit(out)
write.csv(out,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/Temp/tst_2012.csv")
...
#mod 3 (5-8 h)
mod3 <- readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod3/AQ.MAIAC.2012.mod3.rds")
...
summary(mod3$pred.m3)
  # saveRDS(mod3,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod3_pred/mod3.pred_mean_PM.AQ_Daily.2012.rds")
   saveRDS(mod3,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod3_pred/mod3.pred.AQ_Daily.2012.rds")
  # saveRDS(mod3,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod3_pred/mod3.pred.AQ_Daily_clean.2012.rds")
...
#calculate stage 3 R2- CV ten folds approach will take 6 weeks...we don't currently do CV for stage 3.
 mod1 <-readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_pred/mod1_Daily.AQ.2012.PM25.predm1.rds")
# mod1 <-readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_pred/mod1_Daily.AQ.2012.PM25_clean.predm1.rds")
...
# saveRDS(res, "/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2012/resALL.AQ_Daily.2012.PM25_mean.rds")
 saveRDS(res, "/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2012/resALL.AQ_Daily.2012.PM25.rds")
# saveRDS(res, "/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2012/resALL.AQ_Daily_clean.2012.PM25.rds")

#create final prediction data set for use in health outcome studies

#import mod2
 mod2<- readRDS( "/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod2_pred/mod2.AQ_Daily.2012.PM.predm2.rds")
...
#save
 # saveRDS(mod3best,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/Best_pred/bestpred.AQ_Daily.2012.PM25_mean.rds")
  saveRDS(mod3best,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/Best_pred/bestpred.AQ_Daily.2012.PM25.rds")
 # saveRDS(mod3best,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/Best_pred/bestpred.AQ_Daily_clean.2012.PM25.rds")
...
out<-na.omit(out)
 write.csv(out,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/Best_pred/map.bestpred.AQ_Daily.2012.PM25.csv")
# write.csv(out,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/Best_pred/map.bestpred.AQ_Daily_clean.2012.PM25.csv")
...
res_clean_IDW=readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2012/resALL.AQ_Daily_clean.2012.PM25.rds")
res_clean_IDW=res_clean_IDW[,1:33]
# Filtered data using mean PM
res_clean_mean_PM=readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2012/resALL.AQ_Daily_clean.2012.PM25_bymean.rds")
res_clean_mean_PM=res_clean_mean_PM[,1:33]
# All data using IDW
res_all_IDW=readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2012/resALL.AQ_Daily.2012.PM25.rds")
res_all_IDW=res_all_IDW[,1:33]
# All data using mean_PM
res_all_mean_PM=readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2012/resALL.AQ_Daily.2012.PM25.rds")
...
write.csv(res_all,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2012/results.all_mods.2012.PM25.csv")
