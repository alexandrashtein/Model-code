...
# AQUA data
mod1 <-readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1/2009/mod1.AQ.2009.PM25_Daily.rds")
# mod1<-readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1/2009/mod1.AQ.2009.PM25_Hourly.rds")

# TERRA data
# mod1 <-readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1/2009/mod1.TR.2009.PM25_Daily.rds")
# mod1 <-readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1/2009/mod1.TR.2009.PM25_Hourly.rds")
...
hpbl=filter(hpbl,hpbl$year=="2009")
...
# delete unnecessery columns for 2008-2009
...
# mod1[,c("sp_ndvi_L14","su_ndvi_L14","m","lon_200m","lat_200m","ndviid","FS_BS","Su_NDVI14_200m","Sp_NDVI14_200m","P_Ag_2009","P_In_Min_2009","P_OS_2009","P_OS_Ag_2009","P_Ag_2009_200m","P_In_Min_2009_200m","P_OS_Ag_2009_200m","P_OS_2009_200m"):=NULL]
...
# names for AQUA daily mod1- for year > 2009
...
# names for hourly mod1 AQUA- for years > 2009

# names=c("Elev","sp_ndvi_L14","su_ndvi_L14","dis_inventory","Dis_Mroads","road_den","Pop_dens","Dis_Rd1_2012","Dis_Rd2_2012","Dist_Railw",
# "Dist_WB","metreg_IA" ,"metreg" ,"aridity_in","P_Ag_2009","P_In_Min_2009","P_OS_2009","P_OS_Ag_2009","P_Ur_2004","Temp_H",
# "WS_H","RH_H","Rain_H","NO2_H" ,"SO2_H","pbl_02","pbl_11","vc_H","aod_055_mean","aod_047_mean","Elev_200m","Pop_dens_200m",
# "Road_den_200m" ,"Road_dis_200m","Dis_Railways_200m" ,"Sp_NDVI14_200m","Su_NDVI14_200m","P_Ag_2009_200m","P_In_Min_2009_200m","P_OS_Ag_2009_200m","P_OS_2009_200m","P_Ur_2004_200m","dist_inven_200m","ndvi")


# names for Daily mod1 AQUA- for years < 2009
...
# # names for hourly mod1 AQUA- for years < 2009
# 
# names=c("Elev","sp_ndvi_L0002","su_ndvi_L0002","dis_inventory","Dis_Mroads","road_den","Pop_dens","Dis_Rd1_2012","Dis_Rd2_2012","Dist_Railw",
...
# names for TERRA daily mod1- for year > 2009

# names=c("Elev","sp_ndvi_L14","su_ndvi_L14","dis_inventory","Dis_Mroads","road_den","Pop_dens","Dis_Rd1_2012","Dis_Rd2_2012","Dist_Railw",
# "Dist_WB","metreg_IA" ,"metreg" ,"aridity_in","Temp_D", "P_Ag_2009","P_In_Min_2009","P_OS_2009","P_OS_Ag_2009","P_Ur_2004",
# "WS_D","RH_D","Rain_D","NO2_D" ,"SO2_D","pbl_02","pbl_08","vc_D","aod_055_mean","aod_047_mean","Elev_200m","Pop_dens_200m",
# "Road_den_200m" ,"Road_dis_200m","Dis_Railways_200m" ,"P_Ag_2009_200m","P_In_Min_2009_200m","P_OS_Ag_2009_200m","P_OS_2009_200m","P_Ur_2004_200m","Sp_NDVI0002_200m",
# "Sp_NDVI14_200m","Su_NDVI0002_200m","Su_NDVI14_200m","dist_inven_200m","ndvi","daily_hpbl")

# names for hourly mod1 TERRA- for years > 2009

# names= c("Elev","sp_ndvi_L14","su_ndvi_L14","dis_inventory","Dis_Mroads","road_den","Pop_dens","Dis_Rd1_2012",
# "Dis_Rd2_2012","Dist_Railw","Dist_WB","metreg","ndvi",
# "P_Ag_2009","P_In_Min_2009","P_OS_2009","P_OS_Ag_2009","P_Ur_2004",
...
# "P_Ag_2009_200m","P_In_Min_2009_200m","P_OS_2009_200m","P_Ur_2004_200m","dist_inven_200m")

# names for Daily mod1 TERRA- for years > 2009
...
# "P_Ag_2009_200m","P_In_Min_2009_200m","P_OS_2009_200m","P_Ur_2004_200m","dist_inven_200m","daily_hpbl")
...
## for Daily dataset- 2009 year

##v1 mixed model
m1.formula <- as.formula(PM25 ~ aod_047_mean
                         # #spatial
                         +Elev.scaled+dis_inventory.scaled + Dis_Mroads.scaled
                         + road_den.scaled + Pop_dens.scaled + Dis_Rd2_2012.scaled + Dist_Railw.scaled
                         ...
                         +(1+aod_047_mean|day/Ur_Ru_2))

m1.formula <- as.formula(PM25 ~ aod_047_mean
                         # #spatial
                         +Elev.scaled+dis_inventory.scaled
                         +Pop_dens.scaled+Dis_Rd1_2012.scaled 
                         +P_In_Min_2014.scaled+P_Ur_2014.scaled +P_Ag_2014.scaled
                         #temporal
                         + daily_hpbl.scaled+vc_D.scaled
                         #met
                         + Temp_D.scaled+Rain_D.scaled+RH_D.scaled+WS_D.scaled+NO2_D.scaled
                         +(1+aod_047_mean|day/Ur_Ru_2))
...
# x<-gam(PM25~ s(Dis_Mroads.scaled),data=mod1)
# plot(x)
# summary(x)

#save MOD1 
# saveRDS(mod1,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_pred/mod1_Daily.AQ.2009.PM25.predm1.rds")
saveRDS(mod1,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_pred/mod1_Daily.AQ.2009.PM25_clean.predm1.rds")
# saveRDS(mod1,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_pred/mod1_hourly.AQ.2009.PM25_clean.predm1.rds")
# saveRDS(mod1,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_pred/mod1_hourly.AQ.2009.PM25.predm1.rds")

# saveRDS(mod1,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_pred/mod1_Daily.TR.2009.PM25.predm1.rds")
# saveRDS(mod1,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_pred/mod1_Daily.TR.2009.PM25_clean.predm1.rds")
# saveRDS(mod1,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_pred/mod1_hourly.TR.2009.PM25_clean.predm1.rds")
# saveRDS(mod1,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_pred/mod1_hourly.TR.2009.PM25.predm1.rds")

# Save AQUA results 
# saveRDS(res,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/results.mod1.AQ.2009.PM25_Daily.rds")
saveRDS(res,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/results.mod1.AQ.2009.PM25_Daily_clean.rds")
# saveRDS(res,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/results.mod1.AQ.2009.PM25_Hourly_clean.rds")
# saveRDS(res,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/results.mod1.AQ.2009.PM25_Hourly.rds")  
# Save TERRA results
# saveRDS(res,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/results.mod1.TR.2009.PM25_Daily.rds")
# saveRDS(res,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/results.mod1.TR.2009.PM25_Daily_clean.rds")
# saveRDS(res,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/results.mod1.TR.2009.PM25_Hourly_clean.rds")
# saveRDS(res,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/results.mod1.TR.2009.PM25_Hourly.rds")
...
#save
# AQUA
# saveRDS(mod1.cv,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_CV/mod1.AQ.2009.PM25_Daily_CV.rds")     
saveRDS(mod1.cv,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_CV/mod1.AQ.2009.PM25_Daily_clean_CV.rds")
# saveRDS(mod1.cv,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_CV/mod1.AQ.2009.PM25_Hourly_CV.rds")
# saveRDS(mod1.cv,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_CV/mod1.AQ.2009.PM25_Hourly_clean_CV.rds")

# TERRA
# saveRDS(mod1.cv,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_CV/mod1.TR.2009.PM25_Hourly_clean_CV.rds")
# saveRDS(mod1.cv,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_CV/mod1.TR.2009.PM25_Hourly_CV.rds")
# saveRDS(mod1.cv,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_CV/mod1.TR.2009.PM25_Daily_CV.rds")     
# saveRDS(mod1.cv,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_CV/mod1.TR.2009.PM25_Daily_clean_CV.rds")
...
#        Sp_NDVI14_200m.scaled+ P_Ur_2009_200m.scaled +  P_Ag_2009_200m.scaled +P_In_Min_2009_200m.scaled +
#       P_OS_2009_200m.scaled  ,data=mod1.cv)
# 
# reg=lm(res.m1~ Elev_200m.scaled + Road_den_200m.scaled + Road_dis_200m.scaled + Pop_dens_200m.scaled+    
#          Sp_NDVI14_200m.scaled +  P_Ag_2009_200m.scaled +P_In_Min_2009_200m.scaled + 
#           P_Ur_2009_200m.scaled ,data=mod1.cv)
# 
# reg=lm(res.m1~ Elev_200m.scaled + Pop_dens_200m.scaled+Road_dis_200m.scaled +     
#          Dis_Railways_200m.scaled +  Su_NDVI0002_200m.scaled + P_Ur_2009_200m.scaled+dist_inven_200m.scaled
#        +P_In_2009_200m.scaled ,data=mod1.cv)
# 
# summary(reg)
...
# A_res_clean_D=readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2009/results.mod1.AQ.2009.PM25_Daily_clean.rds")
...
# A_res_all_D=readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2009/results.mod1.AQ.2009.PM25_Daily.rds")
# A_res_all_D= subset(A_res_all_D, select = -c(m1cvloc.I))
# A_res_all_D=A_res_all_D[,c(1:35)]
# 
# # (3) read AQUA Hourly clean model results
# A_res_clean_H=readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2009/results.mod1.AQ.2009.PM25_Hourly_clean.rds")
...
# A_res_all_H=readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2009/results.mod1.AQ.2009.PM25_Hourly.rds")
# A_res_all_H=A_res_all_H[,c(1:35)]
# 
# # (5) read TERRA Daily clean model results
# T_res_clean_D=readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2009/results.mod1.TR.2009.PM25_Daily_clean.rds")
# T_res_clean_D=T_res_clean_D[,c(1:35)]
# 
# # (6) read TERRA Daily all obs n model results
# T_res_D_all=readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2009/results.mod1.TR.2009.PM25_Daily.rds")
# T_res_D_all=T_res_D_all[,c(1:35)]
# 
# # (7) read TERRA Hourly clean model results
# T_res_clean_H=readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2009/results.mod1.TR.2009.PM25_Hourly_clean.rds")
# T_res_clean_H=T_res_clean_H[,c(1:35)]
# 
# # (8) read TERRA Hourly all obs n model results
# T_res_all_H=readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2009/results.mod1.TR.2009.PM25_Hourly.rds")
...
# write.csv(res_all,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2009/results.mod1.2009.PM25.csv")

### mod 2 (around 2-4 h)

mod2 <- readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod2/AQ.MAIAC.2009.mod2.rds")
...
names=c("Elev","sp_ndvi_L14", "su_ndvi_L14","dis_inventory","Dis_Mroads","road_den","Pop_dens",
        "Dis_Rd1_2012","Dis_Rd2_2012","Dist_Railw", "Dist_WB","ndvi",
...
gc()
names(mod2)
# saveRDS(mod2,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod2_pred/mod2.AQ.2009.PM.predm2.rds")
saveRDS(mod2,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod2_pred/mod2.AQ_daily_clean.2009.PM.predm2.rds")
...
# out<-na.omit(out)
# write.csv(out,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/Temp/tst_6.csv")
...
# 
#   fit = mgcv::gam(resid ~ s(long_aod,lat_aod),  data= mod2_split[[i]] )
...
#mod 3 (5-8 h)
mod3 <- readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod3/AQ.MAIAC.2009.mod3.rds")
mod3[, m := as.numeric(format(day, "%m")) ]
mod3 <- select(mod3,day,aodid,m,PM25_D_mean,PM25_IDW,long_aod,lat_aod)
mod3$bimon = (mod3$m + 1) %/% 2
setkey(mod3,day, aodid)
mod3<-mod3[!is.na(PM25_IDW)]
...
# saveRDS(mod3,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod3_pred/mod3.pred.AQ_daily.2009.rds")
saveRDS(mod3,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod3_pred/mod3.pred.AQ_daily_clean.2009.rds")
...
mod1 <-readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_pred/mod1_Daily.AQ.2009.PM25_clean.predm1.rds")
# mod1 <-readRDS("/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod1_pred/mod1_Daily.AQ.2009.PM25.predm1.rds")
...
# saveRDS(res, "/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2009/resALL.AQ_Daily.2009.PM25.rds")
saveRDS(res, "/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/results/summary_table/2009/resALL.AQ_daily_clean.2009.PM25.rds")

#create final prediction data set for use in health outcome studies

#import mod2
mod2<- readRDS( "/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/mod2_pred/mod2.AQ.2009.PM.predm2.rds")
mod2=as.data.table(mod2)
...
#save
# saveRDS(mod3best,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/Best_pred/bestpred.AQ_daily.2009.PM25.rds")
saveRDS(mod3best,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/Best_pred/bestpred.AQ_daily_clean.2009.PM25.rds")
...
out<-na.omit(out)
# write.csv(out,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/Best_pred/map.bestpred.AQ_daily.2009.PM25.csv")
write.csv(out,"/media/qnap/Projects/P028.IL.Israel.MAIAC.PM.V2/work/RDS_files/Best_pred/map.bestpred.AQ_daily_clean.2009.PM25.csv")
